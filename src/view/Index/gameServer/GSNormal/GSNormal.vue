<template>
	...
	<div class="main">
		...
		<div class="GSNormal">
			<div class="btn-box">
				<a-button type="primary" style="margin-left: 280px;" @click="save">保存</a-button>
				<a-button type="primary" style="margin-left: 100px;" danger @click="cancel">取消</a-button>
			</div>
			<ul>
				<li>
...
// 服务器的配置
const ServerConfig = ref<ServerConfigType>({
	// 服务器的名字
	ServerName: "",
	// 是否在浏览器中可见
...
// 保存按钮的回调函数
const save = () => {
	squadStore.saveSquadConfig(ServerConfig.value)
}

// 取消按钮 回调
const cancel = () => {
	ServerConfig.value = JSON.parse(JSON.stringify(squadStore.squadConfig))
}
