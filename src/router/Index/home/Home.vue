...
// 系统运行状态
const systemInfo = ["运行流畅", "运行良好", "运行拥堵"]
...
// TODO: 模拟数据改变
setInterval(() => {
    statusValue.cpu = Math.floor((Math.random() * 100).toFixed(2))
...
// TODO: 模拟流量数据改变
setInterval(() => {
    flowMonitorInfo.uploadSeed = (Math.random() * 100).toFixed(2)
    flowMonitorInfo.downloadSpeed = (Math.random() * 100).toFixed(2)
